                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="card rounded-3">
                            ...
                            <div class="card-body p-4 p-md-5">
                                ...
                                <form class="px-md-2" action="../ChangePasswordController" method="get">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="form3Example1q" class="form-control" value="${newPassword}" name="newPassword" maxlength="30" required />
                                    </div>
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example1q">Nhập lại mật khẩu mới<span class="text-danger" > *</span></label>
                                        <input type="text" id="form3Example1q" value="${reNewPassword}" name="reNewPassword" class="form-control" required />
                                    </div>
